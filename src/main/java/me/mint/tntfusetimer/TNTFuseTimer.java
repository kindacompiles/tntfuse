...
public class TNTFuseTimer {
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        // the calibrator. Otherwise vanilla TNT gets measured, and under the lag of a big
        // multi-TNT explosion the client fuse falls behind the server, producing inflated
        // readings that survive the plausibility filter and drag the offset badly negative.
