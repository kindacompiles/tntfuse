...
public final class ModConfig {
    ...
    public static void sync() {
        ...
        bedwarsTickOffset = config.getInt("bedwarsTickOffset", CATEGORY_BEDWARS, 0, -80, 80,
                "Ticks added to the displayed fuse while in a Hypixel Bed Wars game (20 ticks = 1 second).\n"
                        + "Hypixel's TNT does not always use the vanilla 80 tick fuse, so this lets you\n"
                        + "correct the reading. Negative values shorten the displayed time.");
