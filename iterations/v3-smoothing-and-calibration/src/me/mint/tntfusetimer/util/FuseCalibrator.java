 ...
 *
 * <p>Samples are kept in memory only and reset with the game; nothing is written to disk
 * and nothing is requested over the network.</p>
 */
public final class FuseCalibrator {
    ...
    /**
     * The offset to add to a raw fuse value, so negative in practice.
     */
    ...
    /**
     * Median is used rather than mean so one stray sample cannot drag the offset.
     */
