...
public final class BedwarsDetector {
    ...
    /**
     * True if a real Bed Wars game was actually detected, ignoring any manual override.
     * This is what the status overlay should report, so forcing the mode on cannot make
     * the overlay claim a game was detected when it wasn't.
     */
